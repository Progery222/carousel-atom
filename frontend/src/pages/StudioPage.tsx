    ...
    <div className="h-full flex bg-ink-900">
      <aside className="w-80 bg-ink-800 flex flex-col shadow-card">
        ...
        <div className="px-5 pt-4 pb-5 space-y-2 bg-ink-800">
          ...
          <Link
            to="/api-docs"
            title="Public REST API for external services"
            className="w-full inline-flex items-center justify-between gap-2 px-3 py-2 rounded-lg text-xs font-semibold text-accent bg-accent/10 border border-accent/30 hover:bg-accent/20 transition"
          >
      ...
      <main className="flex-1 flex flex-col overflow-hidden bg-ink-900">
        <header className="h-16 flex items-center px-8 gap-4 bg-ink-900 border-b border-ink-700/60">
          ...
          <Link
            to="/api-docs"
            className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-accent bg-accent/10 hover:bg-accent/20 rounded-lg transition border border-accent/30"
